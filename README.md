...
- **AI 业务助手**：支持会话管理与归档、自然语言查询物料库存，并将回答中的表格、列表和代码块清晰展示。
...
| AI 助手  | 多轮对话、会话归档、物料库存查询与结构化回答展示                             |
...
<div align="center">
  ...
  <img src="./screenshots/ai-assistant.png" alt="AI 助手查询物料库存" width="90%" />
...
- **AI 能力扩展**：在现有智能问答与库存查询基础上，逐步增加报表摘要和运营建议，辅助制造决策。
