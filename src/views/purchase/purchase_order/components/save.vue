...
watch(
  ...
  (visible) => {
    ...
    Object.assign(form, {
      purchaseDemandId: row?.purchaseDemandId ?? '',
      materialId: row?.materialId ?? '',
      supplierId: row?.supplierId ?? '',
      plannedQuantity: row?.plannedQuantity ?? 1,
...
<template>
  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="110px">
      <el-row :gutter="18">
        <el-col :span="12">
          <el-form-item label="采购需求" prop="purchaseDemandId">
            <PurchaseDemandRefer
              v-model="form.purchaseDemandId"
              :display-text="row?.purchaseDemandNo"
              @change="selectDemand"
            />
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="18">
        ...
        <el-col :span="12">
          <el-form-item label="预计交货" prop="expectedDeliveryDate">
            <el-date-picker
      ...
      <el-row :gutter="18">
        <el-col :span="12">
          <el-form-item label="计划数量" prop="plannedQuantity">
            <el-input-number v-model="form.plannedQuantity" :min="0.0001" :precision="4" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
