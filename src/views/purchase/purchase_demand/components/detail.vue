...
const statusMap: Record<number, string> = {
  [PurchaseDemandStatus.DRAFT]: '草稿',
  [PurchaseDemandStatus.APPROVED]: '已审批',
  [PurchaseDemandStatus.CLOSED]: '已关闭',
}
...
<template>
  <EntityDetailDialog :visible="visible" title="采购需求详情" :row="detail" :fields="fields" @cancel="emit('cancel')" />
</template>
